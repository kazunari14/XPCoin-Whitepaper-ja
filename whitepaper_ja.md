...
充実した人生とは無数の経験によって満たされており、他の人生とは全く違うものとなります。
100歳になるまで狭い世界の中に閉じこもって生きるのは全く良い人生ではありません。
反対に、20代半ばで素晴らしいことをしながら輝かしい栄光に包まれて人生を終えることは、「良い人生」だと考えることができます。
必ずしも20年代半ばで輝かしい栄光に包まれる人生歩めと唱えているわけではありませんが、経験のためには何らかの行動を起こすべきでしょう。「精一杯生きる」ということです。

私達が人生でやることは、全てが経験へと変わります。
旅行やコンサート鑑賞、新しい友達との出会いは、人生の永久的分散型元帳に寄与します。
経験値を使ってみたくはないですか？経験を役立たせる方法を見つけて、自分の人生を有利に生かしたくはありませんか？
経験を積んだ人と会って、まだ知らないユニークな体験を共有したくありませんか？
**経験を共有する経済を容易にするために、XPは作り出されました。**

XPの中心的な前提条件は、それが<u>皆のため</u>であるということです。
...
XPは、あなたが為したこと、行った場所、参加したコミュニティによって、経済全体の可能性を開きます。

<u>XPを始める前に</u>、潜在的なユーザーがXPの使用例を理解することが重要です。
ほとんどの暗号通貨では、使用例は単なる空想でしかありません。
多くの場合、使用方法自体は開発中であり、将来使用できる可能性があるかもしれないといった程度です。 XPでは、すでに使用方法が存在しています。
なぜなら、世界中の人々は、日々経験を積み重ねているからです。

XPという用語は、Dungeons and Dragonsの原作者であるGygax氏、Kaye氏、Blume氏によって最初に使われました。[^1]
それ以来、XPは生活の多くの異なる分野で遍在してきました。ゲーミフィケーションの流行は、かつてはゲームのために用意された「経験値」という概念を、現実に利用することを可能にしました。
経験は、洗濯をすることから犬の散歩をすることまで、非常に多岐に渡ります。
XPは、ポイントの生成から支出先へ戻るまでのトークンの自由な移動を可能にするインセンティブ化構造の提供を活用しようとしています。
